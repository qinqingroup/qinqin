...
<div class="header">
	<div class="container">
		<!--logo-->
			<div class="logo">
				<h1><a href="{{url('index')}}">REAL HOME</a></h1>
			</div>
		<!--//logo-->
		<div class="top-nav">
		...
		<div class="content-middle">
			<div class="container">
				<div class="mid-content">
					...
					<a class="hvr-sweep-to-right more-in" href="{{url('single')}}">Read More</a>
				</div>
			</div>
		</div>
<!--//features-->
		...
		<div class="container">
			...
			<div class="col-md-6 phone-text">
				<h4>Search Homes Everywhere</h4>
					...
					<a href="{{url('mobile_app')}}" class="hvr-sweep-to-right more">Download the App</a>
			</div>
		</div>
	</div>
<!--//phone-->
