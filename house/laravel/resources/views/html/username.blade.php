...
<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<div aria-disabled="false" style="width: 200px;" class="help-block ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" id="input-size-slider"><div style="width: 0%;" class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min"></div><a style="left: 0%;" class="ui-slider-handle ui-state-default ui-corner-all" href="#"></a></div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<div aria-disabled="false" class="help-block ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" id="input-span-slider"><div style="width: 0%;" class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min"></div><a style="left: 0%;" class="ui-slider-handle ui-state-default ui-corner-all" href="#"></a></div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input data-original-title="Hello Tooltip!" data-rel="tooltip" id="form-field-6" placeholder="Tooltip on hover" title="" data-placement="bottom" type="text">
									...
									<div class="form-group">
										...
										<div class="col-sm-9"><div class="tags"><span class="tag">Tag Input Control<button type="button" class="close">×</button></span><input style="display: none;" name="tags" id="form-field-tags" value="Tag Input Control" placeholder="Enter tags ..." type="text"><input placeholder="Enter tags ..." type="text"></div>
