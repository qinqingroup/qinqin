			...
			<div class="col-md-9 single-box">
				<div class="box-col">
				     <div class=" col-sm-7 left-side ">
						<a href="{{url('single')}}"> <img class="img-responsive" src="images/sb.jpg" alt=""></a>
					</div>				
				...
				<div class="box-col">
				     <div class=" col-sm-7 left-side ">
						 <a href="{{url('single')}}"><img class="img-responsive" src="images/sb1.jpg" alt=""></a>
					</div>				
					<div class="  col-sm-5 middle-side">
					     <h4>Possession: Immediate</h4>
					     <p><span class="bath">Bed </span>: <span class="two">2 BHK</span></p>
				...
				<div class="box-col">
				     <div class=" col-sm-7 left-side ">
						<a href="{{url('single')}}"> <img class="img-responsive" src="images/sb2.jpg" alt=""></a>
					</div>				
					<div class="  col-sm-5 middle-side">
					     <h4>Possession: Immediate</h4>
					     <p><span class="bath">Bed </span>: <span class="two">2 BHK</span></p>
				...
				<div class="box-col">
				     <div class=" col-sm-7 left-side ">
						<a href="{{url('single')}}"> <img class="img-responsive" src="images/sb3.jpg" alt=""></a>
					</div>				
					<div class="  col-sm-5 middle-side">
					     <h4>Possession: Immediate</h4>
					     <p><span class="bath">Bed </span>: <span class="two">2 BHK</span></p>
				...
				<div class="box-col">
				     <div class=" col-sm-7 left-side ">
						<a href="{{url('single')}}"> <img class="img-responsive" src="images/sb4.jpg" alt=""></a>
					</div>				
					<div class="  col-sm-5 middle-side">
					     <h4>Possession: Immediate</h4>
					     <p><span class="bath">Bed </span>: <span class="two">2 BHK</span></p>
				...
				<div class="box-col">
				     <div class=" col-sm-7 left-side ">
						 <a href="{{url('single')}}"><img class="img-responsive" src="images/sb5.jpg" alt=""></a>
					</div>				
					<div class="  col-sm-5 middle-side">
					     <h4>Possession: Immediate</h4>
					     <p><span class="bath">Bed </span>: <span class="two">2 BHK</span></p>
