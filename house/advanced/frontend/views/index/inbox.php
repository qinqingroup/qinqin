								...
								<div class="hide message-content" id="id-message-content">
									<div class="message-header clearfix">
										<div class="pull-left">
											...
											&nbsp;
											<img class="middle" alt="John's Avatar" src="<?php Yii::$app->request->baseUrl?>/assets/avatars/avatar.png" width="32" />
											&nbsp;
									...
									<div class="message-attachment clearfix">
										...
										<div class="attachment-images pull-right">
											...
											<div>
												<img width="36" alt="image 4" src="<?php Yii::$app->request->baseUrl?>/assets/images/gallery/thumb-4.jpg" />
												<img width="36" alt="image 3" src="<?php Yii::$app->request->baseUrl?>/assets/images/gallery/thumb-3.jpg" />
												<img width="36" alt="image 2" src="<?php Yii::$app->request->baseUrl?>/assets/images/gallery/thumb-2.jpg" />
												<img width="36" alt="image 1" src="<?php Yii::$app->request->baseUrl?>/assets/images/gallery/thumb-1.jpg" />
											</div>
										</div>
									</div>
								</div><!-- /.message-content -->
...
<![endif]-->
		...
		<script src="<?php Yii::$app->request->baseUrl?>/assets/js/bootstrap-tag.min.js"></script>
		<script src="<?php Yii::$app->request->baseUrl?>/assets/js/jquery.hotkeys.min.js"></script>
		<script src="<?php Yii::$app->request->baseUrl?>/assets/js/bootstrap-wysiwyg.min.js"></script>
		<script src="<?php Yii::$app->request->baseUrl?>/assets/js/jquery-ui-1.10.3.custom.min.js"></script>
		<script src="<?php Yii::$app->request->baseUrl?>/assets/js/jquery.ui.touch-punch.min.js"></script>
		<script src="<?php Yii::$app->request->baseUrl?>/assets/js/jquery.slimscroll.min.js"></script>
