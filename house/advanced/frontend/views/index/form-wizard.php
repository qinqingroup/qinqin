...
<![endif]-->
		...
		<script src="<?=Yii::$app->request->baseUrl?>/assets/js/fuelux/fuelux.wizard.min.js"></script>
		<script src="<?=Yii::$app->request->baseUrl?>/assets/js/jquery.validate.min.js"></script>
		<script src="<?=Yii::$app->request->baseUrl?>/assets/js/additional-methods.min.js"></script>
