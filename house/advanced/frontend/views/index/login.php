...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>登录页面 - China home后台管理系统</title>
							...
							<div class="position-relative">
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										...
										<?php  $form=ActiveForm::begin([ 'action'=>['index/login'],'method'=>'post'])?>
												...
												<fieldset>
											        ...
											        <div class="col-lg-offset-1 col-lg-11">
											            <?= Html::submitButton('Login', ['class' => 'width-65 pull-right btn btn-sm btn-success']) ?>
											        </div>
											    </div>
