					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="index.php?r=index/show">首页</a>
							</li>
...
<![endif]-->
		...
		<script src="<?=Yii::$app->request->baseUrl?>/assets/js/flot/jquery.flot.min.js"></script>
		<script src="<?=Yii::$app->request->baseUrl?>/assets/js/flot/jquery.flot.pie.min.js"></script>
		<script src="<?=Yii::$app->request->baseUrl?>/assets/js/flot/jquery.flot.resize.min.js"></script>
