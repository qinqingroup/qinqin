...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?= Yii::$app->request->baseUrl?>/assets/css/jquery.gritter.css" />
		<link rel="stylesheet" href="<?= Yii::$app->request->baseUrl?>/assets/css/select2.css" />
		<link rel="stylesheet" href="<?= Yii::$app->request->baseUrl?>/assets/css/bootstrap-editable.css" />
											...
											<div class="profile-user-info profile-user-info-striped">
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="username"><?php echo $v['u_name']?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														...
														<span class="editable" id="country"><?php echo $v['u_zhuzhi']?></span>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="age"><?php echo $v['u_sex']?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="signup"><?php echo $v['u_time']?></span>
													</div>
												</div>
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="username"><?php echo $v['u_email']?></span>
													</div>
												</div>
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="username"><?php echo $v['u_phone']?></span>
													</div>
												</div>
													...
													<div class="widget-main padding-8">
														<div id="profile-feed-1" class="profile-feed">
															<div class="profile-activity clearfix">
																<div>
																	<img class="pull-left" alt="Alex Doe's avatar" src="<?= Yii::$app->request->baseUrl?>/assets/avatars/avatar5.png" />
															...
															<div class="profile-activity clearfix">
																<div>
																	<img class="pull-left" alt="Susan Smith's avatar" src="<?= Yii::$app->request->baseUrl?>/assets/avatars/avatar1.png" />
															...
															<div class="profile-activity clearfix">
																<div>
																	<img class="pull-left" alt="David Palms's avatar" src="<?= Yii::$app->request->baseUrl?>/assets/avatars/avatar4.png" />
											...
											<div class="tab-content no-border padding-24">
												<div id="home" class="tab-pane in active">
													<div class="row">
														<div class="col-xs-12 col-sm-3 center">
															<span class="profile-picture">
																<img class="editable img-responsive" alt="Alex's Avatar" id="avatar2" src="<?= Yii::$app->request->baseUrl?>/assets/avatars/profile-pic.jpg" />
															</span>
													...
													<div class="profile-users clearfix">
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="<?= Yii::$app->request->baseUrl?>/assets/avatars/avatar4.png" alt="Bob Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="<?= Yii::$app->request->baseUrl?>/assets/avatars/avatar1.png" alt="Rose Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="<?= Yii::$app->request->baseUrl?>/assets/avatars/avatar.png" alt="Jim Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="<?= Yii::$app->request->baseUrl?>/assets/avatars/avatar5.png" alt="Alex Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="<?= Yii::$app->request->baseUrl?>/assets/avatars/avatar2.png" alt="Phil Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="<?= Yii::$app->request->baseUrl?>/assets/avatars/avatar3.png" alt="Susan Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="<?= Yii::$app->request->baseUrl?>/assets/avatars/avatar1.png" alt="Jennifer Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="<?= Yii::$app->request->baseUrl?>/assets/avatars/avatar3.png" alt="Alexa Doe's avatar" />
																	</a>
																</div>
...
<![endif]-->
		...
		<!--[if lte IE 8]>
		  <script src="<?= Yii::$app->request->baseUrl?>/assets/js/excanvas.min.js"></script>
		<![endif]-->
		...
		<script src="<?= Yii::$app->request->baseUrl?>/assets/js/jquery.gritter.min.js"></script>
		<script src="<?= Yii::$app->request->baseUrl?>/assets/js/bootbox.min.js"></script>
		...
		<script src="<?= Yii::$app->request->baseUrl?>/assets/js/jquery.hotkeys.min.js"></script>
		<script src="<?= Yii::$app->request->baseUrl?>/assets/js/bootstrap-wysiwyg.min.js"></script>
		<script src="<?= Yii::$app->request->baseUrl?>/assets/js/select2.min.js"></script>
		...
		<script src="<?= Yii::$app->request->baseUrl?>/assets/js/x-editable/bootstrap-editable.min.js"></script>
		<script src="<?= Yii::$app->request->baseUrl?>/assets/js/x-editable/ace-editable.min.js"></script>
