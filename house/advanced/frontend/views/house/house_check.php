											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<?php foreach($arr as $k=>$v){?>
													<tr>
														...
														<td><?php echo $v['house_apartment']?></td>

														<td class="hidden-480">
														<a href="index.php?r=house/upstate&id=<?php  echo $v['house_id'] ?>&state=1" >
                                                        <span class="label label-sm label-warning">通过</span></a>
															<a href="index.php?r=house/upstate&id=<?php  echo $v['house_id'] ?>&state=2" >
                                                        <span class="label label-sm label-end">不通过</span></a
														</td>
													</tr>
                                                    <?php }?>
												</tbody>
